...
//===----------------------------------------------------------------------===//
static void analyseFmiCalls(Module &M) {
...
static cl::OptionCategory FmiCallCategory{"call counter options"};
...
int main(int Argc, char **Argv) {
    ...
    cl::HideUnrelatedOptions(FmiCallCategory);

    cl::ParseCommandLineOptions(Argc, Argv,
                                "Analyse FMI calls in input IR file\n");
